...
import cn.dao.app.di.component.DaggerPracticeComponent
import cn.dao.app.di.module.PracticeModule
import cn.dao.app.mvp.contract.PracticeContract
import cn.dao.app.mvp.presenter.PracticePresenter
 ...
 * }
 */
class PracticeFragment : BaseFragment<PracticePresenter>(), PracticeContract.View {
    companion object {
    ...
    override fun setupFragmentComponent(appComponent: AppComponent) {
        DaggerPracticeComponent //如找不到该类,请编译一下项目
                ...
                .practiceModule(PracticeModule(this))
                .build()
                .inject(this)
    }
